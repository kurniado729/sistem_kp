...
<!--						<form method="post" action="--><?//= base_url('surat_masuk/addmail')?><!--" enctype="multipart/form-data">-->
							<?php echo form_open_multipart(base_url('kontrol_spt/uploadsptbkalengkap/'. $spt['id_surat_spt'])) ?>
							<div class="form-group">
								<div class="custom-file">
									<input type="file" class="custom-file-input" id="file_spt_lengkap" name="file_spt_lengkap" required>
									<label class="custom-file-label" for="file_spt_lengkap">Pilih SPT Lengkap</label>
								</div>
							</div>
						<div class="row">
							<div class="col-3">
								<a href="<?= base_url('kontrol_spt') ?>" class="btn btn-secondary btn-icon-split">
