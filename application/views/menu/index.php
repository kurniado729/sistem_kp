				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="<?= base_url('menu/deletemenu/' . $m['id']); ?>" class="btn btn-danger btn-circle" data-toggle="tooltip" data-placement="top" title="Hapus" onclick="return confirm('Yakin Hapus?')">
