				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="<?= base_url('pegawai/deletepegawaibka/' . $p['id_pegawai']); ?>" class="btn btn-danger btn-circle" data-toggle="tooltip" data-placement="top" title="Hapus" onclick="return confirm('Yakin Hapus?')">
