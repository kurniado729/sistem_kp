		...
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-7">
					<div class="row mb-3">
						<div class="col">
							<form action="<?= base_url('bka/searchbka') ?>" method="post">
				...
				<?php foreach ($bka as $b) : ?>
					<tr>
						...
						<td>
							...
							<a href="<?= base_url('bka/addsuratperintahjalan/' . $b['id_surat_disposisi']); ?>" class="btn btn-success btn-circle" data-toggle="tooltip" data-placement="top" title="Buat Surat Perintah Tugas">
								<i class="fas fa-edit"></i></a>
							<?php else: ?>
								<i class="fas fa-check"> spt sudah dibuat</i>
							<?php endif; ?>
<!--							<a href="--><?//= base_url('bka/makespk/' . $b['id_surat_disposisi']); ?><!--"-->
<!--							   class="badge badge-success">Lihat surat perintah kerja</a>-->
	...
	<?php if($this->uri->segment(2) == 'searchbka'): ?>
