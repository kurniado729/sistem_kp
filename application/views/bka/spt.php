		...
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-7">
					<div class="row mb-3">
						<div class="col">
							<form action="<?= base_url('bka/searchspt') ?>" method="post">
				...
				<?php foreach ($spt as $s) : ?>
					<tr>
						...
						<td>
							...
							<a href="<?= base_url('bka/ajukanspt/' . $s['id_surat_spt']); ?>" class="btn btn-warning btn-circle tombol-ajukan-spt" data-toggle="tooltip" data-placement="top" title="Ajukan SPT">
