...
<!--						<form method="post" action="--><?//= base_url('surat_masuk/addmail')?><!--" enctype="multipart/form-data">-->
							<?php echo form_open_multipart(base_url('surat_disposisi/uploaddisposisibka/'. $surat_disposisi['id_surat_disposisi'])) ?>
						...
						<div class="row">
							<div class="col-3">
								<a href="<?= base_url('surat_disposisi/disposisibka') ?>" class="btn btn-secondary btn-icon-split">
