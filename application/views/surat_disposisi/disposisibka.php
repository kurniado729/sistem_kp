...
<div class="container-fluid">
				...
				<?php foreach ($surat_disposisi as $sd) : ?>
					<tr>
						...
						<td>
							...
							<a href="<?= base_url('surat_disposisi/formuploaddisposisibka/' . $sd['id_surat_disposisi']); ?>" class="btn btn-success btn-circle" data-toggle="tooltip" data-placement="top" title="Upload Persetujuan Disposisi">
						...
						<td>
							...
							<a href="<?= base_url('surat_disposisi/acceptbka/' . $sd['id_surat_disposisi']); ?>" class="btn btn-success btn-circle" data-toggle="tooltip" data-placement="top" title="Setuju">
								<i class="fas fa-check"></i>
							</a>
								<a href="<?= base_url('surat_disposisi/rejectbka/' . $sd['id_surat_disposisi']); ?>" class="btn btn-danger btn-circle" data-toggle="tooltip" data-placement="top" title="Tolak">
	...
	<?php if($this->uri->segment(2) == 'searchdisposisibka'): ?>
